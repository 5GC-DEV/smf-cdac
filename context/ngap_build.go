...
// Then in your BuildPDUSessionResourceModifyRequestTransfer function, you can use:
// policyUpdate.QosFlowUpdate.GetModified()
// policyUpdate.QosFlowUpdate.GetAdded()
// policyUpdate.QosFlowUpdate.GetDeleted()
